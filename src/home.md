...
route4:
  ...
  var1: '1 вариант: Записываться не нужно, аудиоконтент доступен для всех красноярцев. Выбирайте любой удобный для вас день и время. Карту похода нужно получить в визит-центре Серебряного бора, а треки скачать здесь.'

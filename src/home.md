...
route4:
  ...
  var1: '1 вариант: Записываться не нужно, аудиоконтент доступен для всех красноярцев. Выбирайте любой удобный для вас день и время.'
  var2: '2 вариант: Организованная прогулка с командой Променад По Домам: включена аренда наушников и сопровождение гида. Для участия в этой прогулке нужно иметь физическую подготовку, которая позволит вам идти в темпе группы и не отставать (легкий походный темп).'
  desc: 'Начало маршрута – от Серебряного пруда. Маршрут проходит по живописным тропам второй очереди Гремячей Гривы, где вы подниметесь на хребет Гремячей Гривы, откуда открывается потрясающий вид на окрестности: Енисей, Столбы, Такмак, Овсянка и даже Черная Сопка. <br><br>Проведете несколько минут в медитации на вершине горы, и выйдете на красивую Серебряную поляну. А затем отправитесь в густой лес для того чтобы увидеть скрытую видовку. Маршрут закончится крутым спуском (здесь очень аккуратно, ваши кроссовки не должны скользить!) и выходом к месту старта у Серебряного пруда.'
  list:
    - text: Настраивайтесь на 3 часа похода, подготовьтесь к путешествию ответственно!
...
route5:
  ...
  creation:
    - text: Ксения Кацер
      name: экскурсовод
    - text: Евстолия Емельяновна Шахматова, коренная жительница овсянки, лично знала бабушку Астафьева
      name: в роли бабушки Астафьева
    - text: Лев Ларкович
      name: маленький Астафьев
    - text: Виталий Осипов
      name: взрослый Астафьев
    - text: Алексей Исаченко
      name: дедушка Астафьева
    - text: Андрей Пашнин
      name: издатель Астафьева, Геннадий Сапронов
    - text: Б.Ельцин (пародия)
      name:
    - text: Светлана Ильина
      name: жена Астафьева
    - text: Михал Котюков
      name: губернатор Красноярского края, в роли самого себя
    - text: Вера Якубович
      name: деревенская девушка
    - text: Ольга Белоброва
      name: рассказ «Песнопевица»
    - text: В эпизодах
